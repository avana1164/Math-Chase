...
update = () => {
    ...
    let lastKey = directionInput.lastKey;
    moveCharacter(lastKey);
    
    let spriteY = directionInput.spriteDirection[lastKey][0];
...
moveCharacter = (lastKey) => {
    isMoving = false;
    if (directionInput.spriteDirection['KeyW'][1] && lastKey == 'KeyW') {
        y -= speed;
        isMoving = true;
    } else if (directionInput.spriteDirection['KeyA'][1] && lastKey == 'KeyA'){
        x -= speed;
        isMoving = true;
    } else if (directionInput.spriteDirection['KeyS'][1] && lastKey == 'KeyS'){
        y += speed;
        isMoving = true;
    } else if (directionInput.spriteDirection['KeyD'][1] && lastKey == 'KeyD'){
        x += speed;
        isMoving = true;
    } 
}
